#ifndef FCPP_IO_RAYLIB_CONTROLLER_HPP
#define FCPP_IO_RAYLIB_CONTROLLER_HPP
...
namespace fcpp::io
{
    class FCPP_IO_EXPORT RayLibController;
}

class fcpp::io::RayLibController : public fcpp::io::Controller
{
private:
    struct RayLibControllerData;
public:
...
public:
    RayLibController();
    ~RayLibController() noexcept override;
...
private:
    const std::unique_ptr<RayLibControllerData> dptr;
};
